import { randomInt, sampleSize, shuffle } from 'es-toolkit'
...
const fakers = {
  ...
  fakePhotos() {
    ...
    for (let i = 0; i < 15; i++) {
      photos[photos.length] =
        imageAssets['/src/assets/images/fakers/profile-' + randomInt(1, 16) + '.jpg']?.default || ''
    }
  ...
  fakeImages() {
    ...
    for (let i = 0; i < 15; i++) {
      images[images.length] =
        imageAssets['/src/assets/images/fakers/preview-' + randomInt(1, 16) + '.jpg']?.default || ''
    }
  ...
  fakeDates() {
    ...
    for (let i = 0; i < 5; i++) {
      dates[dates.length] = dayjs
        .unix(randomInt(1586584776897, 1672333200000) / 1000)
        .format('DD MMMM YYYY')
    }
  ...
  fakeFormattedTimes() {
    const times = [
      randomInt(10, 61) + ' seconds ago',
      randomInt(10, 61) + ' minutes ago',
      randomInt(10, 25) + ' hours ago',
      randomInt(10, 21) + ' days ago',
      randomInt(10, 13) + ' months ago',
    ]
    return sampleSize(times, 3)
  },
  fakeTotals() {
    return shuffle([randomInt(20, 221), randomInt(20, 121), randomInt(20, 51)])
  },
  fakeTrueFalse() {
    return sampleSize([false, true, true], 1)
  },
  fakeStocks() {
    return shuffle([randomInt(50, 221), randomInt(50, 121), randomInt(50, 51)])
  },
  fakeProducts() {
    const products = [
